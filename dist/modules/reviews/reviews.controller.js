...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve all reviews' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of reviews retrieved' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Review UUID', example: 'uuid-string' }),
