...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The type of the project', example: 'Social Media' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The type of the project', example: 'Social Media Management', required: false }),
