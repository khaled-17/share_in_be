...
export class VouchersService {
    ...
    // Receipt Vouchers
    async findAllReceipt(filters: any) {
    ...
    async updateReceipt(id: number, data: any) {
        return this.prisma.$transaction(async (tx) => {
            ...
            const { check, ...voucherData } = data;
            const amountDiff =
                (voucherData.amount ? parseFloat(voucherData.amount) : oldVoucher.amount) -
                oldVoucher.amount;
    ...
    // Payment Vouchers
    async findAllPayment(filters: any) {
    ...
    async getStats(type: 'receipt' | 'payment', filters: any) {
